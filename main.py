...
def _quadratic_multiply(x, y):
  ...
  c = BinaryNumber((_quadratic_multiply(c1, c2).decimal_val - a.decimal_val - b.decimal_val))
...
print(test_quadratic_multiply(BinaryNumber(7), BinaryNumber(5), quadratic_multiply))
